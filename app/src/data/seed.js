...
const contacts = [
  // Customers
  { id: seedId('ct', 'pat'),       email: 'pat@evergreenmed.com',  firstName: 'Pat',     lastName: 'Ramirez',  title: 'Director of Facilities', phone: '(206) 555-0201', companyId: clients[0].id, ownerUserId: users[2].id, tagIds: [tagId('vip'), tagId('commercial'), tagId('referral')],     lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(420), notes: 'Primary decision maker. Responsive to texts.',          customFields: {}, createdAt: daysAgo(420), updatedAt: daysAgo(1) },
  { id: seedId('ct', 'morganc'),   email: 'morgan@lakesideop.com',  firstName: 'Morgan',  lastName: 'Choi',     title: 'Office Manager',         phone: '(206) 555-0202', companyId: clients[1].id, ownerUserId: users[3].id, tagIds: [tagId('net30'), tagId('commercial'), tagId('callin')],      lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(380), notes: 'Net-30 terms. Prefers email.',                          customFields: {}, createdAt: daysAgo(380), updatedAt: daysAgo(5) },
  { id: seedId('ct', 'dana'),      email: 'dana@cascadelog.com',    firstName: 'Dana',    lastName: 'Park',     title: 'Operations Lead',        phone: '(206) 555-0203', companyId: clients[2].id, ownerUserId: users[2].id, tagIds: [tagId('commercial'), tagId('webform')],                     lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(340), notes: '',                                                      customFields: {}, createdAt: daysAgo(340), updatedAt: daysAgo(18) },
  { id: seedId('ct', 'sasha'),     email: 'sasha@mtbakerhoa.org',   firstName: 'Sasha',   lastName: 'Lin',      title: 'HOA Board President',    phone: '(206) 555-0204', companyId: clients[3].id, ownerUserId: users[3].id, tagIds: [tagId('residential'), tagId('referral')],                   lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(210), notes: 'Referred by Pacific Ridge.',                            customFields: {}, createdAt: daysAgo(210), updatedAt: daysAgo(10) },
  { id: seedId('ct', 'kim'),       email: 'kim@pacridge.com',       firstName: 'Kim',     lastName: 'Nelson',   title: 'Facility Coordinator',   phone: '(206) 555-0205', companyId: clients[4].id, ownerUserId: users[2].id, tagIds: [tagId('commercial'), tagId('vip'), tagId('callin')],         lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(500), notes: 'Largest account. Quarterly business reviews.',          customFields: {}, createdAt: daysAgo(500), updatedAt: daysAgo(3) },
  { id: seedId('ct', 'lee'),       email: 'lee@olympicsl.com',      firstName: 'Lee',     lastName: 'Thompson', title: 'Resident Services Dir.', phone: '(206) 555-0206', companyId: clients[5].id, ownerUserId: users[3].id, tagIds: [tagId('residential')],                                       lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(150), notes: '',                                                      customFields: {}, createdAt: daysAgo(150), updatedAt: daysAgo(0) },
  { id: seedId('ct', 'quinn'),     email: 'quinn@salishan.org',     firstName: 'Quinn',   lastName: 'Reyes',    title: 'HOA Manager',            phone: '(206) 555-0207', companyId: clients[6].id, ownerUserId: users[2].id, tagIds: [tagId('residential'), tagId('needsquote')],                  lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(90),  notes: 'On hold through Q2.',                                   customFields: {}, createdAt: daysAgo(90),  updatedAt: daysAgo(28) },
  ...
  { id: seedId('ct', 'robin'),     email: 'robin@harborview.co',       firstName: 'Robin',   lastName: 'Vega',   title: 'Property Manager', phone: '(206) 555-0302', companyId: null, ownerUserId: users[2].id, tagIds: [tagId('residential'), tagId('emailcamp')],                     lifecycle: 'lead',     stage: 'drip',        pipelineId: seedId('pl', 'default'), dealValue: 1800, expectedCloseDate: daysFromNow(21), stageChangedAt: daysAgo(5),  notes: 'Harbor View Apartments — 84 units. Common-area cleaning.',          customFields: { company: 'Harbor View Apartments' },     createdAt: daysAgo(8),  updatedAt: daysAgo(5) },
  { id: seedId('ct', 'taylor'),    email: 'taylor@cascadearch.com',    firstName: 'Taylor',  lastName: 'Brooks', title: 'Office Manager',   phone: '(206) 555-0303', companyId: null, ownerUserId: users[2].id, tagIds: [tagId('commercial'), tagId('referral')],                       lifecycle: 'prospect', stage: 'walkthrough', pipelineId: seedId('pl', 'default'), dealValue: 3200, expectedCloseDate: daysFromNow(14), stageChangedAt: daysAgo(3),  notes: 'Referred by Kim Nelson. Moving offices — needs post-construction + recurring janitorial.', customFields: { company: 'Cascade Architecture' }, createdAt: daysAgo(12), updatedAt: daysAgo(3) },
  { id: seedId('ct', 'evvendor'),  email: 'alex@evergreensupply.com',  firstName: 'Alex',    lastName: 'Rivera', title: 'Account Rep',      phone: '(206) 555-0304', companyId: null, ownerUserId: users[2].id, tagIds: [tagId('dnd')],                                                  lifecycle: 'vendor',   stage: null,           pipelineId: null,                    dealValue: null, expectedCloseDate: null,            stageChangedAt: daysAgo(60), notes: 'Cleaning supplies vendor. Net-15.',                                  customFields: { company: 'Evergreen Supply Co' },        createdAt: daysAgo(200), updatedAt: daysAgo(60) },
