...
const contacts = [
  // Customers
  { id: seedId('ct', 'pat'),       email: 'pat@evergreenmed.com',  firstName: 'Pat',     lastName: 'Ramirez',  title: 'Director of Facilities', phone: '(206) 555-0201', companyId: clients[0].id, ownerUserId: users[2].id, tagIds: [tagId('vip'), tagId('commercial'), tagId('referral')],     visibility: 'org', lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(420), notes: 'Primary decision maker. Responsive to texts.',          customFields: {}, createdAt: daysAgo(420), updatedAt: daysAgo(1) },
  { id: seedId('ct', 'morganc'),   email: 'morgan@lakesideop.com',  firstName: 'Morgan',  lastName: 'Choi',     title: 'Office Manager',         phone: '(206) 555-0202', companyId: clients[1].id, ownerUserId: users[3].id, tagIds: [tagId('net30'), tagId('commercial'), tagId('callin')],      visibility: 'org', lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(380), notes: 'Net-30 terms. Prefers email.',                          customFields: {}, createdAt: daysAgo(380), updatedAt: daysAgo(5) },
  { id: seedId('ct', 'dana'),      email: 'dana@cascadelog.com',    firstName: 'Dana',    lastName: 'Park',     title: 'Operations Lead',        phone: '(206) 555-0203', companyId: clients[2].id, ownerUserId: users[2].id, tagIds: [tagId('commercial'), tagId('webform')],                     visibility: 'org', lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(340), notes: '',                                                      customFields: {}, createdAt: daysAgo(340), updatedAt: daysAgo(18) },
  { id: seedId('ct', 'sasha'),     email: 'sasha@mtbakerhoa.org',   firstName: 'Sasha',   lastName: 'Lin',      title: 'HOA Board President',    phone: '(206) 555-0204', companyId: clients[3].id, ownerUserId: users[3].id, tagIds: [tagId('residential'), tagId('referral')],                   visibility: 'org', lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(210), notes: 'Referred by Pacific Ridge.',                            customFields: {}, createdAt: daysAgo(210), updatedAt: daysAgo(10) },
  { id: seedId('ct', 'kim'),       email: 'kim@pacridge.com',       firstName: 'Kim',     lastName: 'Nelson',   title: 'Facility Coordinator',   phone: '(206) 555-0205', companyId: clients[4].id, ownerUserId: users[2].id, tagIds: [tagId('commercial'), tagId('vip'), tagId('callin')],         visibility: 'org', lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(500), notes: 'Largest account. Quarterly business reviews.',          customFields: {}, createdAt: daysAgo(500), updatedAt: daysAgo(3) },
  { id: seedId('ct', 'lee'),       email: 'lee@olympicsl.com',      firstName: 'Lee',     lastName: 'Thompson', title: 'Resident Services Dir.', phone: '(206) 555-0206', companyId: clients[5].id, ownerUserId: users[3].id, tagIds: [tagId('residential')],                                       visibility: 'org', lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(150), notes: '',                                                      customFields: {}, createdAt: daysAgo(150), updatedAt: daysAgo(0) },
  { id: seedId('ct', 'quinn'),     email: 'quinn@salishan.org',     firstName: 'Quinn',   lastName: 'Reyes',    title: 'HOA Manager',            phone: '(206) 555-0207', companyId: clients[6].id, ownerUserId: users[2].id, tagIds: [tagId('residential'), tagId('needsquote')],                  visibility: 'org', lifecycle: 'customer', stage: null, pipelineId: null, dealValue: null, expectedCloseDate: null, stageChangedAt: daysAgo(90),  notes: 'On hold through Q2.',                                   customFields: {}, createdAt: daysAgo(90),  updatedAt: daysAgo(28) },

  // Leads / prospects / vendor
  { id: seedId('ct', 'jamiep'),    email: 'jamie@greenwooddental.com', firstName: 'Jamie',   lastName: 'Park',   title: 'Practice Manager', phone: '(206) 555-0301', companyId: null, ownerUserId: users[3].id, tagIds: [tagId('hotlead'), tagId('needsquote'), tagId('webform')],     visibility: 'org',     lifecycle: 'lead',     stage: 'hot',         pipelineId: seedId('pl', 'default'), dealValue: 2400, expectedCloseDate: daysFromNow(30), stageChangedAt: daysAgo(2),  notes: 'Inbound via website form. Greenwood Dental Group — 4 operatories.', customFields: { company: 'Greenwood Dental Group' },     createdAt: daysAgo(2),  updatedAt: daysAgo(2) },
  { id: seedId('ct', 'robin'),     email: 'robin@harborview.co',       firstName: 'Robin',   lastName: 'Vega',   title: 'Property Manager', phone: '(206) 555-0302', companyId: null, ownerUserId: users[2].id, tagIds: [tagId('residential'), tagId('emailcamp')],                     visibility: 'org',     lifecycle: 'lead',     stage: 'drip',        pipelineId: seedId('pl', 'default'), dealValue: 1800, expectedCloseDate: daysFromNow(21), stageChangedAt: daysAgo(5),  notes: 'Harbor View Apartments — 84 units. Common-area cleaning.',          customFields: { company: 'Harbor View Apartments' },     createdAt: daysAgo(8),  updatedAt: daysAgo(5) },
  { id: seedId('ct', 'taylor'),    email: 'taylor@cascadearch.com',    firstName: 'Taylor',  lastName: 'Brooks', title: 'Office Manager',   phone: '(206) 555-0303', companyId: null, ownerUserId: users[2].id, tagIds: [tagId('commercial'), tagId('referral')],                       visibility: 'private', lifecycle: 'prospect', stage: 'walkthrough', pipelineId: seedId('pl', 'default'), dealValue: 3200, expectedCloseDate: daysFromNow(14), stageChangedAt: daysAgo(3),  notes: 'Referred by Kim Nelson. Moving offices — needs post-construction + recurring janitorial.', customFields: { company: 'Cascade Architecture' }, createdAt: daysAgo(12), updatedAt: daysAgo(3) },
  { id: seedId('ct', 'evvendor'),  email: 'alex@evergreensupply.com',  firstName: 'Alex',    lastName: 'Rivera', title: 'Account Rep',      phone: '(206) 555-0304', companyId: null, ownerUserId: users[2].id, tagIds: [tagId('dnd')],                                                  visibility: 'org',     lifecycle: 'vendor',   stage: null,           pipelineId: null,                    dealValue: null, expectedCloseDate: null,            stageChangedAt: daysAgo(60), notes: 'Cleaning supplies vendor. Net-15.',                                  customFields: { company: 'Evergreen Supply Co' },        createdAt: daysAgo(200), updatedAt: daysAgo(60) },
  { id: seedId('ct', 'morganns'),  email: 'morgan.hayes@nsauto.com',   firstName: 'Morgan',  lastName: 'Hayes',  title: 'Operations Manager', phone: '(206) 555-0305', companyId: null, ownerUserId: users[3].id, tagIds: [tagId('hotlead'), tagId('commercial'), tagId('callin')],       visibility: 'team',    lifecycle: 'lead',     stage: 'quote',       pipelineId: seedId('pl', 'default'), dealValue: 4500, expectedCloseDate: daysFromNow(10), stageChangedAt: daysAgo(1),  notes: 'Northside Auto Group — 3 locations. Quote sent. Waiting on decision.', customFields: { company: 'Northside Auto Group' },     createdAt: daysAgo(14), updatedAt: daysAgo(1) },
  { id: seedId('ct', 'sambrew'),   email: 'sam@summitbrewing.com',     firstName: 'Sam',     lastName: 'Blake',  title: 'General Manager',  phone: '(206) 555-0306', companyId: null, ownerUserId: users[2].id, tagIds: [tagId('commercial'), tagId('emailcamp')],                       visibility: 'team',    lifecycle: 'prospect', stage: 'walkthrough', pipelineId: seedId('pl', 'default'), dealValue: 2100, expectedCloseDate: daysFromNow(20), stageChangedAt: daysAgo(6),  notes: 'Summit Brewing Co taproom — bi-weekly. Budget confirmed.',          customFields: { company: 'Summit Brewing Co' },          createdAt: daysAgo(10), updatedAt: daysAgo(6) },
];
...
const invoices = [
  { id: 'RFS-1001', clientId: clients[0].id, billingContactId: contacts[0].id, siteId: siteFor('evgrn-main').id, jobIds: [], issueDate: daysAgo(3),  dueDate: atTime(27, 12, 0), lineItems: [li('Weekly janitorial — Main Hospital', 4, 350)], taxRate: 0, status: 'paid',    payments: [{ id: seedId('pay', 'p1'), date: daysAgo(1), amount: 1400, method: 'ACH',   note: '' }],         createdAt: daysAgo(3) },
  { id: 'RFS-1002', clientId: clients[1].id, billingContactId: contacts[1].id, siteId: siteFor('lake-main').id,  jobIds: [], issueDate: daysAgo(4),  dueDate: atTime(26, 12, 0), lineItems: [li('Monthly floor care', 1, 650)],                  taxRate: 0, status: 'paid',    payments: [{ id: seedId('pay', 'p2'), date: daysAgo(2), amount: 650,  method: 'Card',  note: '' }],         createdAt: daysAgo(4) },
  { id: 'RFS-1003', clientId: clients[4].id, billingContactId: contacts[4].id, siteId: siteFor('pac-tower').id,  jobIds: [], issueDate: daysAgo(6),  dueDate: atTime(24, 12, 0), lineItems: [li('Bi-weekly janitorial — Tower A', 2, 475)],      taxRate: 0, status: 'pending', payments: [],                                                                                            createdAt: daysAgo(6) },
  { id: 'RFS-1004', clientId: clients[5].id, billingContactId: contacts[5].id, siteId: siteFor('oly-main').id,   jobIds: [], issueDate: daysAgo(8),  dueDate: atTime(22, 12, 0), lineItems: [li('Weekly restroom sanitation', 4, 195)],          taxRate: 0, status: 'pending', payments: [],                                                                                            createdAt: daysAgo(8) },
  { id: 'RFS-1005', clientId: clients[3].id, billingContactId: contacts[3].id, siteId: siteFor('mtb-clbhs').id,  jobIds: [], issueDate: daysAgo(10), dueDate: atTime(20, 12, 0), lineItems: [li('Monthly window cleaning — Clubhouse', 1, 285)], taxRate: 0, status: 'paid',    payments: [{ id: seedId('pay', 'p3'), date: daysAgo(5), amount: 285,  method: 'Check', note: '#1042' }],   createdAt: daysAgo(10) },
  { id: 'RFS-1006', clientId: clients[2].id, billingContactId: contacts[2].id, siteId: siteFor('csc-main').id,   jobIds: [], issueDate: daysAgo(20), dueDate: daysAgo(5),        lineItems: [li('Quarterly pressure washing', 1, 1500)],         taxRate: 0, status: 'overdue', payments: [],                                                                                            createdAt: daysAgo(20) },
  { id: 'RFS-1007', clientId: clients[6].id, billingContactId: contacts[6].id, siteId: siteFor('sal-main').id,   jobIds: [], issueDate: daysAgo(30), dueDate: daysAgo(15),       lineItems: [li('Post-construction cleanup', 1, 950)],           taxRate: 0, status: 'overdue', payments: [],                                                                                            createdAt: daysAgo(30) },
  { id: 'RFS-1008', clientId: clients[0].id, billingContactId: contacts[0].id, siteId: siteFor('evgrn-clnc').id, jobIds: [], issueDate: daysAgo(14), dueDate: atTime(16, 12, 0), lineItems: [li('Weekly janitorial — Annex Clinic', 4, 320)],   taxRate: 0, status: 'paid',    payments: [{ id: seedId('pay', 'p4'), date: daysAgo(7), amount: 1280, method: 'ACH',   note: '' }],         createdAt: daysAgo(14) },
];
