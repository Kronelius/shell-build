...
- **`CLAUDE.md`** — project context, file map, deployment model.
- **`SHELL_ROADMAP.md`** — what's built, what's pending. Cosmetic rules in this file apply to all CORE-section work.
